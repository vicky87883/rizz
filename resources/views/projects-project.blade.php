                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="{{ asset('assets/images/logos/lang-logo/dropbox.png')}}" alt="" height="80" class="rounded-circle d-inline-block">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="{{ asset('assets/images/logos/lang-logo/slack.png')}}" alt="" height="80" class="rounded-circle d-inline-block">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="{{ asset('assets/images/logos/lang-logo/dribbble.png')}}" alt="" height="80" class="rounded-circle d-inline-block">
