                                            ...
                                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="{{ asset('assets/images/extra/card/img-2.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{ asset('assets/images/extra/card/img-1.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{ asset('assets/images/extra/card/img-3.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 text-center">
                                            <div id="carouselExample" class="carousel slide">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="{{ asset('assets/images/extra/card/img-4.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{ asset('assets/images/extra/card/img-5.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{ asset('assets/images/extra/card/img-6.jpg')}}" class="d-block w-100" alt="...">
                                                    </div>
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5 offset-lg-1 align-self-center">
                                            <div class="p-3">
                                                <span class="bg-pink-subtle p-1 rounded text-pink fw-medium">Captions </span>
                                                <h1 class="my-4 font-weight-bold">Manage Your Work With <span class="text-primary">Rizz</span>.</h1>
                                                <p class="fs-14 text-muted">Rizz is a Bootstrap 5 admin dashboard, 
                                                    It is fully responsive and included awesome features 
                                                    to help build web applications fast and easy.
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 offset-lg-1 align-self-center">
                                            <div class="p-3">
                                                <span class="bg-pink-subtle p-1 rounded text-pink fw-medium">Crossfade</span>
                                                <h1 class="my-4 font-weight-bold">Manage Your Work With <span class="text-primary">Rizz</span>.</h1>
                                                <p class="fs-14 text-muted">Rizz is a Bootstrap 5 admin dashboard, 
                                                    It is fully responsive and included awesome features 
                                                    to help build web applications fast and easy.
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5 offset-lg-1 align-self-center">
                                            <div class="p-3">
                                                <span class="bg-pink-subtle p-1 rounded text-pink fw-medium">Dark variant </span>
                                                <h1 class="my-4 font-weight-bold">Manage Your Work With <span class="text-primary">Rizz</span>.</h1>
                                                <p class="fs-14 text-muted">Rizz is a Bootstrap 5 admin dashboard, 
                                                    It is fully responsive and included awesome features 
                                                    to help build web applications fast and easy.
                                        ...
                                        <div class="col-lg-5 offset-lg-1 text-center">
                                            <div id="carouselExampleDark" class="carousel carousel-dark slide">
                                                ...
                                                <div class="carousel-inner">
                                                  ...
                                                  <div class="carousel-item">
                                                    <img src="assets/images/extra/card/img-6.jpg" class="d-block w-100" alt="...">
                                                    <div class="carousel-caption d-none d-md-block">
