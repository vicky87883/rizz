                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('assets/images/logos/lang-logo/gdrive.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('assets/images/logos/lang-logo/dropbox.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('assets/images/logos/lang-logo/onedrive.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('assets/images/logos/lang-logo/server.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                                                        ...
                                                        <tr>                                                        
                                                            ...
                                                            <td class="text-end">
                                                                <div class="img-group d-flex justify-content-end">
                                                                    ...
                                                                    <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                                        <img src="{{ asset('assets/images/users/avatar-10.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                                                    </a>                 
                                                                </div>
                                                            </td>
                                                            <td class="text-end">   
