                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        <table class="table  mb-0 table-centered">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/lang-logo/chatgpt.png')}}" alt="" class="rounded-circle thumb-md me-1 d-inline">
                                                    Micromin
                                                </td>
                                                <td>4</td>
                                                <td>$250</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/lang-logo/nextjs.png')}}" alt="" class="rounded-circle thumb-md me-1 d-inline">
                                                    ZZ Diamond
                                                </td>
                                                <td>2</td>
                                                <td>$180</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/lang-logo/reactjs.png')}}" alt="" class="rounded-circle thumb-md me-1 d-inline">
                                                    Dairy Sweet
                                                </td>
                                                <td>6</td>
                                                <td>$210</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logos/lang-logo/symfony.png')}}" alt="" class="rounded-circle thumb-md me-1 d-inline">
                                                    Corner Tea
                                                </td>
                                                <td>3</td>
                                                <td>$80</td>
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><img src="{{ asset('assets/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle thumb-md me-1 d-inline"> Aaron Poulin</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle thumb-md me-1 d-inline"> Richard Ali</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle thumb-md me-1 d-inline"> Juan Clark</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('assets/images/users/avatar-6.jpg')}}" alt="" class="rounded-circle thumb-md me-1 d-inline"> Albert Hull</td>
