...
<html lang="en" dir="ltr" data-startbar="light" data-bs-theme="light">
    ...
    <body>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-1.jpg')}}" alt="" class="thumb-md rounded-circle me-1">
                                                        Unity Pugh
                                                    </td>
                                                    <td>9958</td>
                                                    <td>Curicó</td>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-2.jpg')}}" alt="" class="thumb-md rounded-circle me-1">
                                                        Theodore Duran
                                                    </td>
                                                    <td>8971</td>
                                                    <td>Dhanbad</td>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-3.jpg')}}" alt="" class="thumb-md rounded-circle me-1">
                                                        Kylie Bishop
                                                    </td>
                                                    <td>3147</td>
                                                    <td>Norman</td>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-4.jpg')}}" alt="" class="thumb-md rounded-circle me-1">
                                                        Willow Gilliam
                                                    </td>
                                                    <td>3497</td>
                                                    <td>Amqui</td>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-5.jpg')}}" alt="" class="thumb-md rounded-circle me-1">
                                                        Blossom Dickerson
                                                    </td>
                                                    <td>5018</td>
                                                    <td>Kempten</td>
        ...
        <script src="{{ asset('assets/js/pages/analytics-customers.init.js')}}"></script>
