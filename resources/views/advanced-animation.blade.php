...
<html lang="en" dir="ltr" data-startbar="light" data-bs-theme="light">
    ...
    <head>
        ...
        <meta charset="utf-8" />
                ...
                <!-- No additional code needed here for your request -->
                <!-- App favicon -->
                <link rel="shortcut icon" href="{{ asset('assets/images/favicon.ico')}}">

       
        <link rel="stylesheet" href="{{ asset('assets/libs/magic.css/magic.min.css')}}">
         <!-- App css -->
                                        ...
                                        <div class="position-relative d-inline-block mx-auto">
                                            <div id="animate-me">
                                                <div class="shadow-sm p-4 d-inline-block rounded-circle">
                                                    <img src="{{ asset('assets/images/logo-sm.png')}}" alt="" class="center-block thumb-xl">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div id="content" class="col-lg-6 mx-auto text-center button-list container-magic-bottom container text-center">
                                                <div style="height: 450px;" data-simplebar>
                                                    ...
                                                    <button type="button" class="btn btn-outline-secondary btn-sm btn-animation mb-1"
