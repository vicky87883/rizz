                                        ...
                                        <div class="col ">
                                            <div class="d-flex align-items-center">
                                                <div class="position-relative">
                                                    <img src="{{ asset('assets/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle img-fluid">
                                                    <div class="position-absolute top-50 start-100 translate-middle">
                                                        <img src="{{ asset('assets/images/flags/baha_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-white">
                                                    </div>
                                                </div>
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="ecommerce-order-details">#632536</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><a href="ecommerce-order-details">#365485</a></td>
                                                    <td>
                                                        <p class="d-inline-block align-middle mb-0">
                                                ...
                                                <tr>
                                                    <td><a href="ecommerce-order-details">#325415</a></td>
                                                    <td>
                                                        <p class="d-inline-block align-middle mb-0">
                                                ...
                                                <tr>
                                                    <td><a href="ecommerce-order-details">#546987</a></td>
                                                    <td>
                                                        <p class="d-inline-block align-middle mb-0">
                                                ...
                                                <tr>
                                                    <td><a href="ecommerce-order-details">#951236</a></td>
                                                    <td>
                                                        <p class="d-inline-block align-middle mb-0">
