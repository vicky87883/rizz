                    ...
                    <div class="row">                        
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/nextjs.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Nextjs Devloper Team</h5>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-1.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                    ...
                                    <div class="mt-3 text-center">                                        
                                        <a href="apps-chat.html" class="btn btn-outline-primary px-2 d-inline-flex align-items-center"><i class="iconoir-chat-bubble fs-14 me-1"></i>Message</a>
                                    </div>
                                </div><!--end card-body-->  
                            </div><!--end card-->                             
                        </div> <!--end col-->
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/reactjs.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Reactjs Devloper Team</h5>
                                        <p class="text-muted mb-0">@karen</p>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-2.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/svelte.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Sveltejs Devloper Team</h5>
                                        <p class="text-muted mb-0">@karen</p>
                                        ...
                                        <div class="img-group d-flex justify-content-center mt-3">
                                            ...
                                            <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                <img src="assets/images/users/avatar-9.jpg" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                            </a>
                                            <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                <img src="assets/images/users/avatar-4.jpg" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                            </a>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-3.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/vue.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Vuejs Devloper Team</h5>
                                        <p class="text-muted mb-0">@karen</p>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-8.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/symfony.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Symfony Devloper Team</h5>
                                        <p class="text-muted mb-0">@karen</p>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-7.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center border-dashed-bottom pb-3">
                                        <img src="assets/images/logos/lang-logo/nodejs.png" alt="" height="80" class="rounded-circle d-inline-block">
                                        <h5 class="m-0 fw-bold mt-2 fs-20">Nodejs Devloper Team</h5>
                                        <p class="text-muted mb-0">@karen</p>
                                    ...
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                                            <div class="d-flex align-items-center">
                                                <img src="assets/images/users/avatar-10.jpg" class="me-2 align-self-center thumb-lg rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
