                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <div id="grid" class="row g-0">
                                        ...
                                        <div class="col-md-4 col-lg-3 picture-item">
                                            <a href="{{ asset('assets/images/extra/card/img-5.jpg')}}" class="lightbox">
                                                <img src="{{ asset('assets/images/extra/card/img-5.jpg')}}" alt="" class="img-fluid" />
                                            </a> 
                                        </div>
                                        <div class="col-md-4 col-lg-3 picture-item picture-item--overlay">
                                            <a href="{{ asset('assets/images/extra/card/img-6.jpg')}}" class="lightbox">
                                                <img src="{{ asset('assets/images/extra/card/img-6.jpg')}}" alt="" class="img-fluid" />
                                            </a> 
                                        </div>
                                        <div class="col-md-4 col-lg-3 picture-item picture-item--h2">
                                            <a href="{{ asset('assets/images/extra/card/img-2.jpg')}}" class="lightbox">
