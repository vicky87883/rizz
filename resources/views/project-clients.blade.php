                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    ...
                                    <div class="mt-3">
                                        <a href="pages-profile" class="btn btn-sm btn-primary px-2 d-inline-flex align-items-center"><i class="iconoir-user fs-14 me-1"></i>View Profile</a>
                                        <a href="apps-chat" class="btn btn-sm btn-outline-primary px-2 d-inline-flex align-items-center"><i class="iconoir-chat-bubble fs-14 me-1"></i>Message</a>
                                    </div>
                                </div><!--end card-body-->  
                            </div><!--end card-->                             
                        </div> <!--end col--> 
