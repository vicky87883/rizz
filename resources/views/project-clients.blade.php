                    ...
                    <div class="row">                        
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-1.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/baha_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-2.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/us_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-3.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/french_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-4.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/germany_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-5.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/russia_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="assets/images/users/avatar-6.jpg" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="assets/images/flags/spain_flag.jpg" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
