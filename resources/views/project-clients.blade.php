                    ...
                    <div class="row">                        
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/baha_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        <a href="pages-profile.html" class="btn btn-sm btn-primary px-2 d-inline-flex align-items-center"><i class="iconoir-user fs-14 me-1"></i>View Profile</a>
                                        <a href="apps-chat.html" class="btn btn-sm btn-outline-primary px-2 d-inline-flex align-items-center"><i class="iconoir-chat-bubble fs-14 me-1"></i>Message</a>
                                    </div>
                                </div><!--end card-body-->  
                            </div><!--end card-->                             
                        </div> <!--end col--> 
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/us_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/french_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/germany_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/russia_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">                                
                                ...
                                <div class="card-body mt-n5">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/users/avatar-6.jpg')}}" alt="" class="rounded-circle thumb-xxl">
                                        <div class="position-absolute top-0">
                                            <img src="{{ asset('assets/images/flags/spain_flag.jpg')}}" alt="" class="rounded-circle thumb-sm border border-3 border-dark">
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        <div class="col-auto col-md-6">
