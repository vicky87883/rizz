                                        ...
                                        <table class="table mb-0 checkbox-all" id="datatable_1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/04.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Apple Watch</a> 
                                                            <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/01.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Morden Chair</a> 
                                                            <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/05.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Reebok Shoes</a> 
                                                            <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/06.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Cosco Vollyboll</a> 
                                                            <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/04.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Royal Purse</a> 
                                                            <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/03.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">New Morden Chair</a> 
                                                            <br>
                                                            <span class="text-muted font-13">size-05 (Model 2021)</span> 
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/02.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Important Chair</a> 
                                                            <br>
                                                            <span class="text-muted font-13">size-05 (Model 2021)</span> 
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/02.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Nivya Footboll</a> 
                                                            <br>
                                                            <span class="text-muted font-13">Size-05 (Model 2021)</span> 
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/01.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Green Morden Chair</a> 
                                                            <br>
                                                            <span class="text-muted font-13">Size-Mediam (Model 2021)</span> 
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <img src="{{ asset('assets/images/products/01.png')}}" alt="" height="40">
                                                        <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details" class="d-inline-block align-middle mb-0 product-name">Bata Shoes</a> 
                                                            <br>
                                                            <span class="text-muted font-13">size-08 (Model 2021)</span> 
                                                        </p>
                                                    </td>
