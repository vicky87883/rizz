                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <img src="{{ asset('assets/images/extra/card/img-1.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-10.jpg')}}" alt="" class="thumb-md rounded-circle">
                                                </div>                                      
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <img src="{{ asset('assets/images/extra/card/img-2.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3 ">
                                        ...
                                        <a href="" class="d-block fs-18 fw-medium text-body my-2 text-truncate">Where does psoriasis usually start?</a>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-9.jpg')}}" alt="" class="thumb-md rounded-circle">
                                                </div>                                      
                                                <div class="flex-grow-1 ms-2 text-truncate text-start">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <img src="{{ asset('assets/images/extra/card/img-3.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3 ">
                                        ...
                                        <a href="" class="d-block fs-18 fw-medium text-body my-2 text-truncate">What Can Yoga Do for Migraine Relief?</a>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-8.jpg')}}" alt="" class="thumb-md rounded-circle">
                                                </div>                                      
                                                <div class="flex-grow-1 ms-2 text-truncate text-start">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/images/extra/card/img-4.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3 ">
                                        ...
                                        <a href="" class="d-block fs-18 fw-medium text-body my-3 text-truncate">How Long Do Migraine Attacks Last? What to Expect</a>
                                        <p class="text-muted">It is a long established fact that a reader will be  distracted by the readable content of a page when looking at its layout.</p>
                                        <hr class="hr-dashed">
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-7.jpg')}}" alt="" class="thumb-md rounded-circle">
                                                </div>                                      
                                                <div class="flex-grow-1 ms-2 text-truncate text-start">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/images/extra/card/img-5.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3 ">
                                        ...
                                        <a href="" class="d-block fs-18 fw-medium text-body my-3 text-truncate">Your 5-Minute Read on Beating Stress</a>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-6.jpg')}}" alt="" class="thumb-md rounded-circle">
                                                </div>                                      
                                                <div class="flex-grow-1 ms-2 text-truncate text-start">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/images/extra/card/img-6.jpg')}}" alt="" class="img-fluid rounded"/>
                                        <div class="mt-3 ">
                                        ...
                                        <a href="" class="d-block fs-18 fw-medium text-body my-3 text-truncate">World Oral Health Day 2023</a>
