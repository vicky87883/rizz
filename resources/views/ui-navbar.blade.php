                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                        <div class="container-fluid">
                                            <a class="navbar-brand" href="#">
                                                <img src="{{ asset('assets/images/logo-sm.png')}}" height="26" alt="" class="me-1">
                                            </a>
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light mt-2">
                                        <div class="container-fluid">
                                            <a class="navbar-brand" href="#">
                                                <img src="{{ asset('assets/images/logo-sm.png')}}" height="26" alt="" class="me-2">
                                                <img src="{{ asset('assets/images/logo-dark.png')}}" height="16" alt="">
                                            </a>
