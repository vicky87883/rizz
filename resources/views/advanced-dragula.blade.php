                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-start" class="p-3 pt-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/meta.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/nextjs.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/reactjs.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/chatgpt.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                            ...
                                            <div class="d-flex justify-content-between fw-semibold align-items-center  my-3">
                                                <div class="img-group d-flex justify-content-center">
                                                    ...
                                                    <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                        <img src="{{ asset('assets/images/users/avatar-9.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                                    </a>
                                                    <a href="" class="user-avatar position-relative d-inline-block ms-1">
                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-center" class="p-3 pt-0">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/nodejs.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/gitlab.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/vue.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                            ...
                            <div class="border-dashed border-theme-color rounded">
                                <div class="card bg-light ">
                                    <div class="card-body border-dashed-bottom border-theme-color">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ asset('assets/images/users/avatar-7.jpg')}}" alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                ...
                                <div id="project-list-end" class="p-3 pt-0">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/symfony.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="position-absolute  end-0 me-3">
                                                <span class="badge rounded text-danger bg-transparent border border-danger">Complated</span>
                                            </div>
                                            <div class="d-flex align-items-center mb-3 pb-2 border-dashed-bottom">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/slack.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
                                            ...
                                            <div class="d-flex justify-content-between fw-semibold align-items-center  my-3">
                                                <div class="img-group d-flex justify-content-center">
                                                    <a class="user-avatar position-relative d-inline-block" href="#">
                                                        <img src="{{ asset('assets/images/users/avatar-8.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                                    </a>
                                                    <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                        <img src="{{ asset('assets/images/users/avatar-7.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                                    </a>
                                                    <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                                        <img src="{{ asset('assets/images/users/avatar-5.jpg')}}" alt="avatar" class="thumb-md shadow-sm rounded-circle">
                                                    </a>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/logos/lang-logo/python.png')}}" alt="" height="50" class="rounded-circle d-inline-block">
                                                </div>
                                                <div class="flex-grow-1 ms-2 text-truncate">
